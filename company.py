...
"""
data = {
    'file_names': ['input/Amazon_dataset.csv', 'input/Google_dataset.csv'],
...
def main():
    ...
    job = input("Enter your current job: ") # Get user's current job
    # Print user information to check
    data = [[name, age, begin, degree, major, job]]
    headers = ['Name', 'Age', 'First Coding Age', 'Highest Degree', 'Related Major?', 'Current Job']
